...
export default function Favorites() {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      // Consulta a la tabla de relación (asumiendo 'product_likes' o similar)
      // Ajusta 'product_likes' al nombre real de tu tabla intermedia
      ...
      const formattedFavorites = data.map(item => ({
        ...item.product,
        liked_at: item.created_at, // Fecha en que se dio like
